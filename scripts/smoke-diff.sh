...
echo "Building @dtifx/core, @dtifx/cli, @dtifx/dscp, @dtifx/diff, @dtifx/build, and @dtifx/audit packages for smoke test" >&2
pnpm exec nx run-many -t build --projects core,cli,dscp,diff,build,audit --output-style=static
